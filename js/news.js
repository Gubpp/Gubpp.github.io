(function(){
  ...
  //轮播图数据
    var carouselDatas=[
      ...
      createCarousel("newCarousel",carouselDatas);


//第二页  
//新闻数据
//从腾讯服务器获取数据
  ajax("https://apps.game.qq.com/cmc/cross?serviceId=166&source=web_pc&filter=channel&chanid=4897&typeids=1&limit=4&start=0&sortby=sIdxTime").then(function(resp){
    var ul=$(".news_list");
    var html="";
